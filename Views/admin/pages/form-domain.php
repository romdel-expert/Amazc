...
<div class="page-admin">
    ...
    <div class="top">
        ...
        <h1 class="mt-3">Nouveau domaine d'intervention</h1>
    </div>

    <form class="mt-3" action="/?page=admin&act=saveDomain" enctype="multipart/form-data" method="POST">

        <div class="mb-3">
            <label for="titleD" class="form-label">Titre</label>
            <input type="text" name="title" class="form-control" id="titleD" value="<?= $titleDomain ?>"
        ...
        <div class="mb-3">
            ...
            <input type="file" name="file_event" class="form-control" accept=".jpg, .png, .jpeg, .JPG, .JPEG, .PNG"
                id="file_event_d" aria-describedby="file_eventHelp" required>
        </div>


        <div class="mb-3">
            <label for="descriptionD" class="form-label">Décrire le domaine</label>
...
$title = "Formulaire d'enregistrerment d'un nouveau domaine d'intervention de l'association michel archange zero chomage";
